...
// [[Rcpp::export]]
List slfm_MDN(NumericMatrix x, double a = 2.1, double b = 1.1, double gamma_a = 1, double gamma_b = 1, 
              double omega_1 = 10, int burnin = 1000, int lag = 1, int npost = 500) {
    ...
    for(int k = 0; k < ite; k++) {
        ...
        for(int i = 0; i < m; i++) {
            ...
            // qstar normalization
            A = R::dnorm(0, m_alpha_1, sqrt(v_alpha_1), true);
